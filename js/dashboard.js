...
function getRoutesInfo() {
  ...
  let originFromForm =
    selectOriginList.options[selectOriginList.selectedIndex].text;
  let destinationFromForm =
    selectDestinationList.options[selectDestinationList.selectedIndex].text;
