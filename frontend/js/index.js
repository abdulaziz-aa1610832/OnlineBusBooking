...
function validateLogin() {
    ...
    if (username == "") {
        document.getElementById("usernameLoginError").innerHTML = "Username required*";
    }
    if (password == "") {
        document.getElementById("passwordLoginError").innerHTML = "Password required*";
    }
}
...
function validateSignUp() {
    ...
    if (fullName == "") {
        document.getElementById("fullNameSignUpError").innerHTML = "Full name required*";
    }
    if (email == "") {
    ...
    if (password == "") {
        document.getElementById("passwordSignUpError").innerHTML = "Password required*";
    }
}
...
function changeToSignUp() {
   ...
   <div id="buttons">
       ...
       <a class="btn" onclick="validateSignUp()" id="regbtn">Register</a>
  ...
  `
    ...
    //onclick="registerUser()" in the Register button previously in the dynamic html above
}
